dungeon_gen_4 through 4.1

basic idea:
  - fresh start
  - keep the good ideas from 1/2/3
  - keep code from becoming confusing
...
result:
  ...
  - 4.1 will generate a bunch of rooms that are always connected
    and it is quite tunable. i will consider this the first
    successful dungeon generator i've made.
